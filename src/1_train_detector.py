...
def get_classification_datas(sample_num, model_name, model_path):
    '''
    :param sample_num: total data to sample
...
if __name__ == '__main__':
    ...
    parser.add_argument('--hf_token', type=str, default='XXX', help='set your huggingface token here')
    ...
    get_classification_datas(sample_num=args.sample, model_name=model_name, model_path=model_path)
